                                    ...
                                    <div class="mb-3">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <input class="custom-control-input" type="checkbox" id="track_qty"
                                                name="track_qty" value="Yes" value="{{($product->track_qty == 'Yes') ? 'checked' : ''}}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <select name="is_featured" id="is_featured" class="form-control">
                                    <option {{($product->is_featured == $category->id) ? 'selected' : 'No'}} value="No">No</option>
                                    <option {{($product->is_featured == $category->id) ? 'selected' : 'Yes'}} value="Yes">Yes</option>
                                </select>
                                <p class="error"></p>
                            </div>
                        </div>
